...
public class ReceiveTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
         ...
         Log.d(GeofenceUtils.APPTAG, "ReceiveTransitionsIntentService:onHandleEvent");
        ...
        if (LocationClient.hasError(intent)) {
            ...
            // String errorMessage = LocationServiceErrorMessages.getErrorString(this, errorCode);
             String errorMessage = "Location service error" ;
		...
		broadcastIntent.putExtra("TRANSITION_TYPE", transitionType);
		broadcastIntent.putExtra("GEOFENCE_IDS", geofenceIds);
                LocalBroadcastManager.getInstance(this).sendBroadcast(broadcastIntent);
